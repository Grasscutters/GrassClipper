# ! ВНИМАНИЕ !
Новый лаунчер, в число разработчиков которых входит и автор, находится в разработке. К сожалению, это означает, что автор не может посвятить время поддержке GrassClipper, поскольку он занят разработкой нового. Однако, это не является чем-то плохим, поскольку новый лаунчер уже на текущий момент более стабилен и имеет больше функций. Если у Вас имеются проблемы с GrassClipper, автор рекомендует дождаться нового лаунчера.
